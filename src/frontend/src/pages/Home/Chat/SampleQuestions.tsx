  ...
  const sampleQuestions = [
    {
      ...
      text: "I like good quality nova phones. What is the most expensive phone you have, and what are the comments that people say about this product? - Logged in as cust010 (new request)",
    },
    {
